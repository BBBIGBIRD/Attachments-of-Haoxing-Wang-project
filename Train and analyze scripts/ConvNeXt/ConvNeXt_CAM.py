...
from model import convnext_tiny as create_model  # 确保从您的模型文件导入模型定义
...
if __name__ == "__main__":
    ...
    save_path = 'C://Users//15097//Desktop//训练过程结果//ConvNeXt_heatmap.jpg'  # 热力图保存路径
    ...
    # 选择目标层, 使用最后的深度卷积层
    target_layer = model.stages[-1][-2].dwconv
